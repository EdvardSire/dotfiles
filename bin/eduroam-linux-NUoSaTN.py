...
Config.instname = "Norwegian University of Science and Technology " \
    "(NTNU)"
Config.profilename = "eduroam NTNU"
Config.url = "https://i.ntnu.no/wiki/-/wiki/English/Wireless+network"
Config.email = "orakel@ntnu.no"
Config.title = "eduroam CAT"
Config.server_match = "radius.ntnu.no"
...
Config.user_realm = "ntnu.no"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius.ntnu.no']
