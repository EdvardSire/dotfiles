...
_G.packer_plugins = {
  ...
  ["cmp-nvim-lua"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/cmp-nvim-lua",
  ...
  ["nord-vim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/nord-vim",
  ...
  ["vim-airline"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/vim-airline",
    url = "https://github.com/vim-airline/vim-airline"
  },
  ["vim-commentary"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/vim-commentary",
